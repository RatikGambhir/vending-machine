...
with a list of all com.techelevator.items in the vending machine with its quantity remaining:
...
7. The purchase process flow is as follows:
    ...
    purchase.
        ...
        remaining. Dispensing also returns a message:
          - All chip com.techelevator.items print "Crunch Crunch, Yum!"
          - All candy com.techelevator.items print "Munch Munch, Yum!"
          - All drink com.techelevator.items print "Glug Glug, Yum!"
          - All gum com.techelevator.items print "Chew Chew, Yum!"
